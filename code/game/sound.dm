...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if("law")
				soundin = pick('sound/voice/god.ogg', 'sound/voice/iamthelaw.ogg', 'sound/voice/secureday.ogg', 'sound/voice/radio.ogg', 'sound/voice/insult.ogg', 'sound/voice/creep.ogg')
			if("honkbot_e")
				soundin = pick('sound/items/bikehorn.ogg', 'sound/items/AirHorn2.ogg', 'sound/misc/sadtrombone.ogg', 'sound/items/AirHorn.ogg', 'sound/effects/reee.ogg',  'sound/items/WEEOO1.ogg', 'sound/voice/iamthelaw.ogg', 'sound/voice/creep.ogg','sound/magic/Fireball.ogg' ,'sound/effects/pray.ogg', 'sound/voice/hiss1.ogg','sound/machines/buzz-sigh.ogg', 'sound/machines/ping.ogg', 'sound/weapons/flashbang.ogg', 'sound/weapons/bladeslice.ogg')
